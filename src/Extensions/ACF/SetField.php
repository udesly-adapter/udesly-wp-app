...
class SetField extends \acf_field {
	function initialize() {

		// vars
		$this->name = 'set';
		$this->label = __("Set",'acf');
	...
	function render_field_settings( $field ) {
		...
		?><tr class="acf-field acf-field-setting-sub_fields" data-setting="set" data-name="sub_fields">
		<td class="acf-label">
